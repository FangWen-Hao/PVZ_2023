...
namespace game_framework
{
	const vector<vector<int>> Level_7_zombie_instruction{
		...
		{(int)ZOMBIE_INSTRUCTION_TYPE::NORMAL, 322, 0, 0},
		{(int)ZOMBIE_INSTRUCTION_TYPE::NORMAL, 324, 0, 0},

		{(int)ZOMBIE_INSTRUCTION_TYPE::NEWSPAPER, 322, 1, 0},
		{(int)ZOMBIE_INSTRUCTION_TYPE::NORMAL, 322, 1, 0},

		{(int)ZOMBIE_INSTRUCTION_TYPE::NEWSPAPER, 320, 2, 0},
		{(int)ZOMBIE_INSTRUCTION_TYPE::NORMAL, 322, 2, 0},
		

		{(int)ZOMBIE_INSTRUCTION_TYPE::NORMAL, 320, 3, 0},
		{(int)ZOMBIE_INSTRUCTION_TYPE::NORMAL, 322, 3, 0},
		{(int)ZOMBIE_INSTRUCTION_TYPE::NORMAL, 324, 3, 0},
